...
3. Search for "Code Grouping Extension"
4. Click Install

### Manual Installation

1. Download the .vsix file from the [releases page](https://github.com/yourusername/code-grouping-extension/releases)
...
1. Clone the repository:
   ```
   git clone https://github.com/yourusername/code-grouping-extension.git
   ```
2. Navigate to the project directory:
   ```
   cd code-grouping-extension
   ```
...
1. Open the Code Groups Explorer in one of these ways:
   - Click on the Code Groups icon in the Activity Bar
   - Find "Code Groups" in the Explorer view
   - Open the Command Palette (Ctrl+Shift+P / Cmd+Shift+P) and run "View: Show Code Groups"
...
1. Click on the Code Groups indicator in the status bar (or press `Ctrl+Shift+G` / `Cmd+Shift+G`)
...
- Check the Output panel (View → Output → Code Grouping Extension) for detailed logs
- For large workspaces, the initial scan may take a moment to complete

## Contributing

Contributions are welcome! Please open an issue or submit a pull request on our [GitHub repository](https://github.com/yourusername/code-grouping-extension).
